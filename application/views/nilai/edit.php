                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            //Open Form
                            echo form_open_multipart(base_url('nilai/edit/'.$nilai->id_nilai),$atribut);
                            ?>
                            <input type="hidden" name="id_pelajaran" class="form-control" value="<?= $nilai->id_pelajaran?>" >
                            <input type="hidden" name="nis" class="form-control" value="<?= $nilai->nis?>" >
                                <div class="form-group"><label class="col-sm-2 control-label">Mata Pelajaran</label>

                                    <div class="col-sm-4">
                                        <input type="text" name="pelajaran" class="form-control" value="<?= $nilai->pelajaran?>" disabled>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Nama  Siswa</label>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="pelajaran" class="form-control" value="<?= $nilai->nama_siswa?>" disabled>


                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Rata-Rata Nilai Tugas</label>

                                    <div class="col-sm-4">
                                        <input type="text" name="tugas" class="form-control" value="<?= $nilai->tugas?>" required>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Nilai UTS</label>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="uts" class="form-control" value="<?= $nilai->uts?>" required>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Nilai UAS</label>
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="uas" class="form-control" value="<?= $nilai->uas?>" required>
