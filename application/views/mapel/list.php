                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $mapel->nama_pegawai ?></td>
                                <td class="text-center">
                                    <a href="<?= base_url('mapel/edit/'.$mapel->id_pelajaran) ?>" class="btn btn-warning btn-sm">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    <a href="<?= base_url('mapel/delete/'.$mapel->id_pelajaran) ?>" class="btn btn-danger btn-sm">
