                        ...
                        <div class="ibox-content">
                            ...
                            ?>
                                <div class="form-group"><label class="col-sm-2 control-label">Nama Mata Pelajaran</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" name="pelajaran" class="form-control" value="<?= set_value('pelajaran') ?>" required></div>
                                </div>
                                ...
                                <div class="col-sm-10">
                                        <select class="form-control m-b" name="nip">
                                            ...
                                            <?php foreach ($pegawai as $sm) : ?>
                                            <option value="<?= $sm->nip ?>"><?= $sm->nip ?> - <?= $sm->nama_pegawai ?></option>
                                            <?php endforeach;?>
                                        </select>
