                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            //Open Form
                            echo form_open_multipart(base_url('mapel/edit/'.$mapel->id_pelajaran),$atribut);
                            ?>
                                <div class="form-group"><label class="col-sm-2 control-label">Nama Mata Pelajaran</label>

                                    <div class="col-sm-10"><input type="text" name="pelajaran" class="form-control" value="<?= $mapel->pelajaran ?>" required></div>
                                </div>
                                
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                <div class="form-group"><label class="col-sm-2 control-label">Guru</label>
                                ...
                                <select class="form-control m-b" name="nip">
                                            ...
                                            <?php
                                                foreach ($pegawai as $pegawai) {
                                                    if ($pegawai->nip == $mapel->nip) {
                                            ?>
                                                        <option value="<?= $pegawai->nip ?>"  <?= "selected";?>>
                                                        <?= $sm->nip ?> - <?= $pegawai->nama_pegawai?>
                                                        </option>
                                                <?php 
                                                    }else{
                                                ?>
                                                        <option value="<?= $pegawai->nip ?>"><?= $sm->nip ?> - <?= $pegawai->nama_pegawai ?></option>
                                                <?php        
                                                    }
                                                    ?>
