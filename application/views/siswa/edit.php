                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            //Open Form
                            echo form_open_multipart(base_url('siswa/edit/'.$siswa->nis),$atribut);
                            ?>
                                <div class="form-group"><label class="col-sm-2 control-label">NIS</label>

                                    <div class="col-sm-10"><input type="text" name="nis" class="form-control" value="<?= $siswa->nis ?>" readonly></div>
                                </div>
                                ...
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">No.HP Siswa</label>

                                    <div class="col-sm-10"><input type="text" name="hp_siswa" class="form-control" value="<?= $siswa->hp_siswa ?>" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
