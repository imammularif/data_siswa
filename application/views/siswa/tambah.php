                        ...
                        <div class="ibox-content">
                            ...
                            ?>
                                <div class="form-group"><label class="col-sm-2 control-label">NIS</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" name="nis" class="form-control" value="<?= set_value('nis') ?>" required></div>
                                </div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">No.HP Siswa</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" name="hp_siswa" class="form-control" value="<?= set_value('hp_siswa') ?>" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
